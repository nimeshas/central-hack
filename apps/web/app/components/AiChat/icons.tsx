...
export function ReportIcon({ size = 14 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function InsightsIcon({ size = 14 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ComplianceIcon({ size = 14 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function AlertCircleIcon({ size = 14 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
